...
export const householdConfig = {
  ...
  naverBandLinkSlots: [
    { id: 'parents-band-1', householdId: 'parents', label: '부모님 밴드 1', placeholderHref: 'https://band.us/band/parents-placeholder-1', status: 'placeholder' },
    { id: 'parents-band-2', householdId: 'parents', label: '부모님 밴드 2', placeholderHref: 'https://band.us/band/parents-placeholder-2', status: 'placeholder' },
    { id: 'sister-band-1', householdId: 'sister', label: '누나네 밴드 1', placeholderHref: 'https://band.us/band/sister-placeholder-1', status: 'placeholder' },
    { id: 'sister-band-2', householdId: 'sister', label: '누나네 밴드 2', placeholderHref: 'https://band.us/band/sister-placeholder-2', status: 'placeholder' },
    { id: 'sister-band-3', householdId: 'sister', label: '누나네 밴드 3', placeholderHref: 'https://band.us/band/sister-placeholder-3', status: 'placeholder' },
    { id: 'brother-band-1', householdId: 'brother', label: '형네 밴드', placeholderHref: 'https://band.us/band/brother-placeholder-1', status: 'placeholder' },
    { id: 'home-band-1', householdId: 'home', label: '우리집 밴드', placeholderHref: 'https://band.us/band/home-placeholder-1', status: 'placeholder' },
  ],
