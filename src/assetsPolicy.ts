...
export const EARTH_ASSETS = {
  day: {
    ...
    url: 'https://unpkg.com/three@0.160.0/examples/textures/planets/earth_atmos_2048.jpg',
  ...
  clouds: {
    ...
    url: 'https://unpkg.com/three@0.160.0/examples/textures/planets/earth_clouds_1024.png',
  ...
  night: {
    ...
    url: 'https://unpkg.com/three@0.160.0/examples/textures/planets/earth_lights_2048.png',
